...
class Renderer:
    ...
    def draw_enemy(
        ...
        # Make the ghost slightly larger
        sprite_height = int(
            sprite_height * 1.5
        )
        ...
        # Render in small vertical strips.
        # This allows walls to hide the ghost.
        ...
        for x in range(sprite_width):
            ...
            if distance < wall_distance:
                ...
                source_x = max(
                    0,
                    min(
                        enemy.image.get_width() - 1,
                        source_x
                    )
                )

                column = sprite.subsurface(
                    (
                        x,
                        0,
                        1,
