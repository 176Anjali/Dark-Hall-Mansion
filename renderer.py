...
class Renderer:
    ...
    def __init__(self, mansion_map):
        ...
        self.locked_door_texture = self.load_texture(
            os.path.join(base_path, "locked_door.png")
        )
    ...
    def draw_walls(
        ...
        for column in range(0, WIDTH, 2):
            ...
            # Locked door
                ...
                texture = self.locked_door_texture
    ...
    def draw_keys(
        ...
        for key in self.keys:
            ...
            if (
                ...
                and not self.game.library_puzzle_solved
            ):
                continue

            # Only show library key after vault is opened
            if (
                ...
                and not self.game.vault_unlocked
            ):
            ...
            # Angle between player direction and key
            angle = math.atan2(
                dy,
                dx
            ) - player.angle
